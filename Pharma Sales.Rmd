...
```{r}
# Find optimal value of the parameters using ets function
monthly_N02BE.ets <- ets(train_N02BE, model = "ZZZ")
monthly_N02BE.ets
```
...
```{r}
# Find optimal value of the parameters using ets function
monthly_N05B.ets <- ets(train_N05B, model = "ZZZ")
monthly_N05B.ets
```
...
```{r}
# Find optimal value of the parameters using ets function
monthly_N05C.ets <- ets(train_N05C, model = "ZZZ")
monthly_N05C.ets
```
...
```{r}
# Find optimal value of the parameters using ets function
monthly_R03.ets <- ets(train_R03, model = "ZZZ")
monthly_R03.ets
```
